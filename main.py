...
print("Probability of each outcome for these instances are",logisticModel.predict_proba(X)[0:3])

# picks class with highest probability
logisticModel.predict(X)[0:3]
print("The classes with the highest probability for these instances are",logisticModel.predict(X)[0:3])
